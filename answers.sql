...
SELECT models.name, brand_name, brands.founded FROM models LEFT JOIN brands ON models.brand_name = brands.name WHERE models.year = 1960;
...
SELECT b.name, b.founded, m.name FROM brands
AS b LEFT JOIN models as m ON b.name = m.brand_name  
...
I couldnt get this one to work.  The G section wasnt sorting properly.
